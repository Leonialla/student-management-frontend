  ...
  <div class="student-wrap">
    ...
    <div class="container">
      ...
      <el-row justify="center" type="flex">
        <el-pagination :current-page.sync="pageIndex" :page-size="pageSize" :total="pageSize * pageCount"
          @current-change="getPage" background layout="prev, pager, next">
        </el-pagination>
      </el-row>
      ...
      <div class="table">
        <el-table :data="tableData" stripe>
          ...
          <el-table-column label="上次登录" prop="lastLoginTime" width="130px" />
          <el-table-column align="center" label="操作" width="200px">
            <template slot-scope="scope">
              <el-button @click="edit(scope.row.id)" size="mini" type="success">编辑</el-button>
              <el-button @click="deleteItem(scope.row.id)" size="mini" type="danger">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
...
export default {
  ...
  methods: {
    ...
    save() {
      console.log(this.entityForm.id);
      if (this.entityForm.id === undefined) {
